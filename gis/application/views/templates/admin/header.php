...
<html>
    <head>
        <title>Halaman utama Data Bencana</title>
    ...
    <body>
        ...
        <div id="sidebar" class="tm-sidebar-left uk-background-default">
            ...
            <ul class="uk-nav uk-nav-default">
                ...
                ><a href="<?=base_url('administrator/bencana')?>"><span data-uk-icon="icon:  world" class="uk-margin-small-right"></span>PETA BENCANA</a></li>
